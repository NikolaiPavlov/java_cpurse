...
public class Task45 {
    public static void main(String[] args) {
        ...
        Notebook notebook2 = new Notebook("ROG", "4", "1000", "Lunux", "black");
        Notebook notebook3 = new Notebook("Apple", "4", "2000", "Windows", "black");
        Notebook notebook4 = new Notebook("Xiaomi", "16", "1000", "Windows", "grey");
